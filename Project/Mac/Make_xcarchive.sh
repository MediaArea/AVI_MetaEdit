...
plutil -replace DTSDKName -string "macosx10.9" "$APPNAME.app/Contents/Info.plist"
plutil -replace LSMinimumSystemVersion -string "10.9" "$APPNAME.app/Contents/Info.plist"
